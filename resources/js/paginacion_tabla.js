$.fn.pageMe = function(opts){
    ...
    if (settings.showPrevNext){
        $('<li><a href="#" class="prev_link" title="'+settings.prevText+'"><i class="mdi-image-navigate-before"></i></a></li>').appendTo(pager);
    }
    ...
    if (settings.showPrevNext){
        $('<li><a href="#" class="next_link"  title="'+settings.nextText+'"><i class="mdi-image-navigate-next"></i></a></li>').appendTo(pager);
    }
